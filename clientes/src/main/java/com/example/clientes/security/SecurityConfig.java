package com.example.clientes.security;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/clientes/login").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/v1/clientes").permitAll()
                        .requestMatchers("/api/v1/clientes/*/direcciones").hasAnyRole("CLIENTE", "INTERNO")
                        .requestMatchers(HttpMethod.GET, "/api/v1/clientes/*").hasAnyRole("CLIENTE", "ADMINISTRADOR", "INTERNO")
