    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/productos/*/stock").hasRole("INTERNO")
                        .requestMatchers(HttpMethod.POST, "/api/v1/categorias").hasRole("ADMINISTRADOR")
                        .requestMatchers(HttpMethod.POST, "/api/v1/productos/*/ofertas").hasRole("PROVEEDOR")
                        .requestMatchers(HttpMethod.POST, "/api/v1/productos").hasRole("PROVEEDOR")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/productos/*").hasRole("PROVEEDOR")
